            ...
            '<div class = "row">' +
                ...
                '<div style="text-align:center;" class="col-3 col-md-3">' +
                    ...
                    '<div style ="width: 100%; text-align: -webkit-center;">' +
                        ...
                        '</button>' +
                        '<input type="file" class = "file_anhsp_update" id="file_anhsp_update_desktop'+d.id+'" accept="image/*" style="display: none;">'+
                    '</div>' +
                '</div>'+   
...
//     qrImage.src = src;
//     qrImage.onload = function() {
//         context.drawImage(qrImage, 20, 20, 300, 300);
//         context.font = '20px Arial';
//         context.fillStyle = 'black';
//         context.textAlign = 'center';
//         context.fillText(name, canvas.width / 2, 370); 
...
//                     <img src="${canvas.toDataURL('image/png')}" style="width: 300px; height: 350px;"/>
//                 </body>
//             </html>
//         `);
