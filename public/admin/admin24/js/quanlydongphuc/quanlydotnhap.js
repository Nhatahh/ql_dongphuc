    ...
    var table = $("#loadsanphamdotnhapQLDN").DataTable({
        ...
        columns: [
            ...
            },
            {
                targets: 1,
                name: "masp",
                title: "<div class = 'title_datatables'>Mã SP</div><div class = 'div_datatables'><input id='loadsanphamdotnhapQLDN_masp' onkeyup = search_datatables('loadsanphamdotnhapQLDN_masp') class='form-control input_text_datatables'><i class='fa-solid fa-magnifying-glass i_input_text_datatables'></i></div>",
                data: "masp",
...
async function change_soluong(event, id_sanpham){
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $("#loadsanphamdotnhapQLDN").DataTable().ajax.reload(null, false);
            // load_dssanpham_dot().ajax.url('qldot_load_dssanpham_dot/'+id_dot).load()
