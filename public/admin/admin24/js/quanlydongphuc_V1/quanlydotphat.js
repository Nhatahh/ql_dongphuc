...
var ds_dongphuc_phat = $("#ds_dongphuc_phat").DataTable({
    ...
    columns: [
        ...
        {
            title: "<div style='text-align: center;'>Ưu tiên</div>",
            data: "stt",
            className: 'timkiem_thisinh text-center remove_click',
            render: function(data,type,row ) {
                return '<input value="' + data + '"  onchange="change_stt(' + row.id + ', this.value)" style = "border: none;height: 28px;width:100%"type="number" min="0" class=" edit_tabledata stt"/>';
            }
        }
    ],
    language: {
