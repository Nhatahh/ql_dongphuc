...
function nvqs_print_nvqs(){
    ...
    // window.location.href = "https://congmotcua.ctuet.edu.vn/admin/qlsv_nvqs/nvqs_print_nvqs"+'/'+major+'/'+nvqs_id_card+'/'+nvqs_mssv+'/'+load_admin_sig

    window.open('https://congmotcua.ctuet.edu.vn/admin/qlsv_nvqs/nvqs_print_nvqs'+'/'+major+'/'+nvqs_id_card+'/'+nvqs_mssv+'/'+load_admin_sig,'_blank')
