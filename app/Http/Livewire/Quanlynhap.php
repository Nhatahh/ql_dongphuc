...
class Quanlynhap extends Component
{
    public $id_dotnhap;
    ...
    protected $listeners = ['updateData','Scan_QR_quanlynhap'];
    ...
    {
       return $results = DB::table('24_kiemtranhap')
       ->select(
    ...
    public function Scan_QR_quanlynhap($ma_loai, $ma_nhasanxuat, $ma_size)
    {
    ...
    public function render()
    {
        ...
        return view('livewire.quanlynhap',[
