...
class QldpNhap extends Component
{
    public $id_dotnhap;
    ...
    protected $listeners = ['updateData', 'data_iddotnhap','Scan_QR_qldp_nhap'];
    public function mount()
    {
        $this->loadDotnhaps();
    }

    public function data_iddotnhap($id_dotnhap)
    {
    ...
    {
        $this->dotnhaps = DB::table('24_dotnhap')->select('id', 'dotnhap')->get();
    }
    ...
    {
       return $results = DB::table('24_dotnhap_sanpham')
       ->select(
    ...
    public function Scan_QR_qldp_nhap ($ma_loai, $ma_nhasanxuat, $ma_size)
    {
    ...
    public function render()
    {
        ...
        if(count($ds_sanpham_dot) >= 1 || $this->id_nhasanxuat != null || $this->id_loai != null|| $this->id_size != null|| $this->ma_loai != null || $this->ma_size != null|| $this->ma_nhasanxuat != null){
            $trangthai = 1;
        }
        $this->emit('message');

        return view('livewire.qldp-nhap',[
