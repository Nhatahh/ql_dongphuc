                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                <div class="card-header" style="font-weight:normal">
                                    <div class="row">
                                        ...
                                        <div class="col-1">
                                            <button type="button" id="tcsv_excel" onclick="tcsv_excel()" class="load-index btn btn-block btn-primary btn-xs"><i class="fa-regular fa-file-excel"></i></i>&nbsp;&nbsp;Excel</button>
                                        </div>
                                        <div class="col-1">
                                ...
                                <div class="card-body" >
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-12">
                                                            <select  val-def = "-1" class="tcsv form-control ttsv_info" id="tcsv_hoatdong" name = 'update_id_batch_search' style="width: 100%;">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="update_id_card_user_search" class="col-12 col-form-label" style="padding-bottom: 0px ">Dân tộc:</label>
                                                    <div class="col-12">
                                                            <select  val-def = "0" class="tcsv form-control ttsv_info" id="tcsv_dantoc" name = 'update_id_batch_search' style="width: 100%;"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="update_id_card_user_search" class="col-12 col-form-label" style="padding-bottom: 0px ">Tôn giáo:</label>
                                                    <div class="col-12">
                                                            <select   val-def = "0" class="tcsv form-control ttsv_info" id="tcsv_tongiao" name = 'update_id_batch_search' style="width: 100%;"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                            <select  val-def = "-1" class="tcsv form-control ttsv_info" id="tcsv_gioitinh" name = 'update_id_batch_search' style="width: 100%;">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="update_id_card_user_search" class="col-12 col-form-label" style="padding-bottom: 0px ">Nơi sinh:</label>
                                                        <div class="col-12">
                                                            <select  val-def = "0" class="tcsv form-control ttsv_info" id="tcsv_noisinh" name = 'update_id_batch_search' style="width: 100%;"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="update_id_card_user_search" class="col-12 col-form-label" style="padding-bottom: 0px ">Th/Trú:</label>
                                                    <div class="col-12">
                                                            <select  val-def = "0" class="tcsv form-control ttsv_info" id="tcsv_hktt" name = 'update_id_batch_search' style="width: 100%;"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="update_id_card_user_search" class="col-12 col-form-label" style="padding-bottom: 0px ">Quê quán:</label>
                                                    <div class="col-12">
                                                            <select  val-def = "0" class="tcsv form-control ttsv_info" id="tcsv_quequan" name = 'update_id_batch_search' style="width: 100%;"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                        ...
                                        <div class="col-12 col-md-8 col-lg-9" >
                                            <div class="card load-index block-right">
                                                <div class="card-header p-0">Danh sách sinh viên</div>
                                                    <div class="card-body p-1 load-index" >
                                                        <table id = "thuhoso_load_danhsach" class="table table-hover table-striped table-bordered">
                                                            {{-- <thead>
                                                                <tr>
...
<script src="/admin/admin24/js/quanlyhoso/danhsachthuhoso.js"></script>
