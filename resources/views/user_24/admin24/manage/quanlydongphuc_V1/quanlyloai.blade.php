                                ...
                                <div class="row">
                                    <div class="col-12 col-md-3 col-lg-3 ">
                                        <div class="card" style="min-height: 590px">
                                            <div class="card-header p-1" style="font-weight: bold;">Thêm Loại</div>
                                            <div class="card-body" style="padding: 10px 0 0 0;">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row col-md-12 col-12" style="margin-bottom: 3px">
                                                        <label for="loaimoi" class="col-sm-3 col-form-label" style="padding-bottom: 0px">Loại mới:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="loaimoi" name="loaimoi" style="height:28px;">
                                                        </div>
                                                        <span class="text_error error_validate" id = 'error_loaimoi'></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="col-12 col-md-9 col-lg-9 card">
                                        ...
                                        <div class="" style="padding: 15px 0 0 0;" id="ds_loai">
