                            ...
                            <div class="" style="min-height: 590px">
                                <div class="row">
                                    <div class="col-12 col-md-3 col-lg-3">
                                        <div class="card p-1" style="min-height: 590px">
                                            ...
                                            <div class="card-body" style="padding-top: 10px; padding-bottom:0px">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row col-md-12 col-12" style="margin-bottom: 3px">
                                                        <label for="sizemoi" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Size mới:</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="card-body" style="padding-top: 3px; padding-bottom:0px">
                                                        <div class="row">
                                                            <div class="col-md-6 col-6">
                                                                <button type="button" id="" onclick="" class="btn btn-block btn-xs btt_lammoi"><i class="fa-solid fa-rotate"></i>&nbsp;&nbsp;&nbsp;Làm mới</button>
                                                            </div>
                                                            <div class="col-md-6 col-6">
