...
<body class="sidebar-mini sidebar-collapse">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group row" style="margin-bottom: 3px">
                                                ...
                                                <div class=" col-lg-2 col-sm-4 col-6">
                                                    <select class="form-control" id="qlnhap_iddot" onchange="reload_dssanpham_dot()" style="width: 100%;">


                                                    </select>
                                                    <!-- <span class="text_error error_validate" id = 'error_id_dot'></span>  -->
    ...
    <div class="modal" style="z-index: 10;" id="modal_nhapdongphuc">
                ...
                <div class="col-md-12 col-12">
                    <div class="card card-navy card-outline" style="width:85%; height:auto; padding: 2px; background-color:#fff; margin-top: 5%;margin-left: 7%;">
                        ...
                        <div class="" style="padding-bottom: 0px;padding-top: 3px">
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-12 nhap_mobile direct-chat-messages" style = "min-height: 37rem;">
                                    @livewire('qldp-nhap')
                                </div>
