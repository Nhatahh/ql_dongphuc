                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row col-md-12 col-12" style="margin-bottom: 12px">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <span class="text_error_input error_validate" id = 'error-nhasanxuat_moi'></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row col-md-12 col-12" style="margin-bottom: 12px">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <span class="text_error_input error_validate" id = 'error-diachi_moi'></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row col-md-12 col-12" style="margin-bottom: 12px">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <span class="text_error_input error_validate" id = 'error-sdt_moi'></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row col-md-12 col-12" style="margin-bottom: 12px">
                                                        <label for="mansx" class="col-sm-3 col-form-label" style="padding-bottom: 0px">Mã NSX:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="mansx" name="mansx" style="height:28px;">
                                                            <span class="text_error_input error_validate" id = 'error-mansx'></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-12">
                                                    ...
                                                    <div class="card-body" style="padding-top: 3px; padding-bottom:0px">
                                                        <div class="row">
                                                            <div class="col-md-6 col-6">
                                                                <button type="button" id="" onclick="clear_form_nsx()" class="btn btn-block btn-xs btt_lammoi"><i class="fa-solid fa-rotate"></i>&nbsp;&nbsp;&nbsp;Làm mới</button>
                                                            </div>
                                                            <div class="col-md-6 col-6">
