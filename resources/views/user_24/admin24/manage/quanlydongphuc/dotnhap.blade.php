                        ...
                        <div class="col-md-12">                        
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="card card-navy" style="min-height:580px">
                                        <div>
                                            <div class="card-header row" style="padding: 0;margin: 6px 10px 0 10px;; font-weight: bold;padding-bottom: 6px;     ">
                                                <div class="form-group row col-md-6 col-8" style="margin-bottom: 3px">
                                                    <label for="ten_dot_moi" class="col-sm-3 col-form-label" style="padding-bottom: 0px">Tên đợt mới:</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id='ten_dot_moi' name="ten_dot_moi" style="height:28px;">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-4 btt_Themdot">
                                                    <button type="button" onclick="themDot()" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-floppy-disk"></i>&nbsp;&nbsp;&nbsp;Thêm</button>
                                                </div>
