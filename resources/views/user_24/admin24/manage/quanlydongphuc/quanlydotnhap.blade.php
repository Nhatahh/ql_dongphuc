                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card" style="min-height:580px">
                                <div class="card-header row" style="padding: 0;margin: 6px 10px 0 10px;; font-weight: bold;padding-bottom: 6px;">
                                    <div class="form-group row col-md-8 col-8" style="margin-bottom: 3px">
                                        <label for="ten_dot_moi" class="col-sm-5 col-form-label" style="padding-bottom: 0px">Tên đợt mới:</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id='ten_dot_moi' name="ten_dot_moi" style="height:28px;">
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4 col-lg-4 btt_Themdot">
                                        <button type="button" onclick="themDot(event)" id="btt_them_Dot" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-floppy-disk"></i>&nbsp;&nbsp;&nbsp;Thêm</button>
                                    </div>
                                ...
                                <div class="card-body" style="padding-bottom: 0px;padding-top: 3px;" id="">
                                    <table  class="table table-bordered table-hover table-striped dataTable no-footer dtr-inline" id="dsdotnhap"></table>

                                </div>

                            </div>
                        </div>
                        <div class="col-8 ql_dotnhap_desktop">
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="card" style="min-height:580px">
                                        <div class="card-header row" id = "soluongnhap" id_dot = "" style="padding: 0;margin-left: 10px;margin-top: 3px;font-weight: bold;"> Danh sách nhập
                                            <!-- <div class="col-md-3 col-12">
                                                <div class="form-group row" style="margin-bottom: 3px">
                                                    <label for="id_user_check" class="col-sm-3 col-form-label" style="padding-bottom: 0px">Đợt:</label>
                                                    <div class="col-sm-8">
                                                        <select onchange="change_dot()" id="dot_nhap" class="form-control"  style="width: 100%;">
                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 3px" id="list_accounts_tmp">
                                            <table class="table table-bordered table-hover table-striped dataTable no-footer dtr-inline" id="loadsanphamdotnhapQLDN"></table>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="ccol-12 col-md-12 col-lg-12 ql_dotnhap_mobile">
                            @livewire('quanlydotnhap')
                        </div>
                    </div>
                </div>
            </section>
...
<script src="/admin/admin24/js/quanlydongphuc/quanlydotnhap.js"></script>
<!-- <script src="/admin/admin24/js/quanlydongphuc/dotnhap.js"></script> -->
