                        ...
                        <div class="col-12 col-md-8 col-sm-8">
                            <div class="">
                                <fieldset style="height: 570px;" class="card card-body ">
                                    ...
                                    <div  class="row">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <table style="width: 100%; overflow-x: auto;" class="table-bordered table-striped dataTable no-footer dtr-inline" id = "ds_kho">
                                            </table>
                                        </div>
                                        <!-- <div style="padding-bottom:10px;padding-right:1px;padding-top:10px" class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 row"> -->
                                            <div class="col-3 col-sm-5 col-md-5 col-lg-5 col-xl-5"></div>
                                            <div style="padding-bottom:10px;padding-top:10px"  class="col-4 col-sm-3 col-md-3 col-lg-3 col-xl-3 style_all_button">
                                                <button style="height: 28px;" type="button" time="" data-id="" id="bieudo_hoadon_kho" onclick="bieudo_kho()" class="btn btn-block btn-primary btn-xs">
                                                    <i class="fa-regular fa-file-excel"></i>&nbsp;&nbsp;Thống Kê
                                                </button>
                                            </div>
                                            <div class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1 style_all_button"></div>
                                            <div style="padding-bottom:10px;padding-top:10px"  class="col-4 col-sm-3 col-md-3 col-lg-3  col-xl-3 style_all_button">
                                                <button style="height: 28px;" type="button" time="" data-id="" id="btt_excel_kho" onclick="btt_excel_kho()" class="btn btn-block btn-primary btn-xs">
...
<!-- Biểu đồ
<div class="modal" id="modal_bieudo_thongke_kho">
...
<!-- Biểu đồ -->
<div class="modal" id="modal_bieudo_thongke_kho" style="display: none; align-items: center; justify-content: center; min-height: 100vh; position: fixed;">
    <div style="display: flex; justify-content: center; align-items: center; width: 100%; height: 100%;">
        <div class="card card-navy card-outline" style="position: relative; width: 110%; max-width: 1200px; height: 80%; margin: auto; background-color: #fff; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.3);">
                ...
                <div class="row" style="width: 100%;">
                    ...
                    <div class="col-md-1 col-lg-1 col-1">
                        <span class="float-right" style="margin-right: 10px;">
                            <i onclick="close_bieudo_thongke_kho()" id='modal_number_go_wish_start_end_close' class="fas fa-times" style="cursor: pointer;"></i>
                        </span>
                    </div>
                </div>
            </div>
            <div class="card-body" style="padding-bottom: 30px; height: calc(100% - 60px);min-width:100%;">
                <canvas id="dongphuc_kho-chart-canvas" style="display: block;" class="chartjs-render-monitor"></canvas>
                <div class="row">
                    <div class="col-md-10 col-lg-10 col-8 col-xl-10"></div> 
                    <div style="padding-bottom:0px;padding-right:9px;display:none"  class="col-md-2 col-lg-2 col-4 col-xl-2">
