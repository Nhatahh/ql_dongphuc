                ...
                <div class="" >
                    <div class="row">
                        <div  class="col-12 col-md-6 col-sm-12">
                            <fieldset style="height:580px" class="card">
                                <legend>Danh sách đợt phát</legend>
                                <div class="row">
                                    <div class="col-12 col-md-12 col-sm-12">
                                        <div class="card-header">
                                            <div class="form-group row" style="margin-bottom: 3px;">
                                                <label for="name" class="col-3 col-sm-3 col-md-3" style="padding-top: 10px;font-weight:bold">Tên đợt:</label>
                                                <div style="padding-top: 10px" class="col-6 col-sm-6 col-md-6">
                                                    <input id="name" style="height: 28px" type="text" class="form-control" >
                                                </div>
                                                <!-- <div style="padding-top: 10px" class="col-1 col-sm-1 col-md-1"></div> -->
                                                <!-- <div style="padding-top: 10px" class="col-10 col-sm-10 col-md-10"></div> -->
                                                <div style="padding-top: 10px" class="col-3 col-sm-3 col-md-3">
                                                    <button style="height: 28px" type="button" time="" data-id="" id="them_dot" onclick="them_dot()" class="btn btn-block btn-primary btn-xs">
                                    ...
                                    <!-- <div class="card-body"> -->
                                        <div class="col-12 col-md-12 col-sm-12">
                                            <fieldset class="card-body">
                                                <table class="table-bordered table-striped dataTable no-footer dtr-inline" id = "ds_dotphat">
                                                </table>
                                            </fieldset>
                                        </div>
                                    <!-- </div> -->
                        ...
                        <div class="col-12 col-md-6 col-sm-12">
                        <fieldset style="height:580px" class="card">
                            <legend>Danh sách đồng phục phát</legend>
                            <fieldset  class="card-body">
                                <table class="table-bordered table-striped dataTable no-footer dtr-inline" id = "ds_dongphuc_phat">
                                </table>
                            </fieldset>
                        </fieldset>
                    </div>
...
<script src="/admin/admin24/js/quanlydongphuc/quanlydotphat.js"></script>
