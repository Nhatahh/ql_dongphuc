                    ...
                    <fieldset class="">
                        <div class="row">
                            <section class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <fieldset style="padding-top:6px" class="card card-body">
                                    <div style="padding-top:6px" class="row">
                                        <!-- Kiếm theo đợt phát -->
                                        <div  class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                            <div class="form-group row" style="margin-bottom: 3px">
                                                <label for="dotphat_thongkehoadon_search" class="col-sm-5" style="padding-bottom: 0px;font-weight:bold">Đợt nhập:</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div  class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                            <div class="form-group row" style="margin-bottom: 3px">
                                                <label for="loai_thongkehoadon_search" class="col-sm-5" style="padding-bottom: 0px;font-weight:bold">Loại ĐP:</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div  class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                            <div class="form-group row" style="margin-bottom: 3px">
                                                <label for="size_thongkehoadon_search" class="col-sm-5" style="padding-bottom: 0px;font-weight:bold">Size ĐP:</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div  class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                            <div class="form-group row" style="margin-bottom: 3px">
                                                <label for="nsx_thongkehoadon_search" class="col-sm-5" style="padding-bottom: 0px;font-weight:bold">NSX:</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div  class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                            <div class="form-group row" style="margin-bottom: 3px">
                                                <label for="trangthai_thongkehoadon_search" class="col-sm-5" style="padding-bottom: 0px;font-weight:bold">Trạng thái:</label>
                                                <div class="col-sm-7">
                                        ...
                                        <!-- Tìm kiếm -->
                                        <div  class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1">
                                            <button style="height: 28px;" type="button" time="" data-id="" id="search_kho" onclick="bieudo_hoadon_kho()" class="btn btn-block btn-primary btn-xs">
