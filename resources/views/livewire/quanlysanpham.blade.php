                            ...
                            <div class="row col-12">
                                <div class="right" style = "width:100%; height: 100%;">
                                    ...
                                    <div class = "" style ="width: 100%; text-align: -webkit-center;">
                                        <input type="file" class="" accept="image/*" id="file_anhsp_update_mobile{{$row->id}}" onchange="crop_imgsp_update(event,'{{$row->id}}')" style="display: none;">
                                        <label style="width: 55%" class="input_capnhat_Anhsp" for="file_anhsp_update_mobile{{$row->id}}"> Cập nhật</label>
                                    </div>
                                </div>
